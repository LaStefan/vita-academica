                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  {...field}
                                  placeholder='e.g. Utrecht University'
                                />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          Receive email notifications about activity on your
                          account
                        </p>
                      </div>
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          Get reminded to update your CV periodically
                        </p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    ...
                    <div className='flex items-center justify-between'>
                      <div>
                        ...
                        <p className='text-sm text-gray-500'>
                          Receive updates about academic opportunities
                        </p>
                      </div>
                      <Switch defaultChecked />
                    </div>
            ...
            <TabsContent value='integrations'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage your academic platform integrations
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <div className='space-y-4'>
