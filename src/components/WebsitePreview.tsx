  ...
  const renderAcademicTemplate = () => (
    <div className='font-serif'>
      ...
      <div className='max-w-4xl mx-auto p-6'>
        {websiteSettings.sections.about && (
          <div className='mb-8'>
            ...
            <p className='text-gray-700'>
              Academic researcher with expertise in computer science. Currently
        ...
        {websiteSettings.sections.education &&
          cvData.education &&
        ...
        {websiteSettings.sections.experience &&
          cvData.experience &&
        ...
        {websiteSettings.sections.publications &&
          cvData.publications &&
        ...
        {websiteSettings.sections.about && (
          <div className='mb-12'>
            ...
            <p className='text-gray-700 leading-relaxed'>
              Innovative academic researcher with a passion for pushing the
              boundaries of knowledge. My research focuses on the intersection
              of computer science and practical applications.
            </p>
          </div>
        )}
    ...
    <div className='font-sans bg-white text-gray-800'>
      ...
      <div className='max-w-3xl mx-auto px-6 py-8 space-y-12'>
        ...
        {websiteSettings.sections.education &&
          ...
          cvData.education.length > 0 && (
            <div>
              <h2 className='text-xl tracking-wide text-center mb-8'>
                Education
              </h2>
              <div className='space-y-6'>
                {cvData.education.map((edu, index) => (
    ...
    <div className="font-sans bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex items-center justify-center md:justify-end">
              <div className="rounded-full overflow-hidden border-4 border-white h-40 w-40 shadow-md">
                <img src="/professor-profile.jpg" alt="Professor Profile" className="h-full w-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-black text-white py-3 px-6 sticky top-0 z-10 shadow-md">
        <div className="max-w-5xl mx-auto flex gap-6 overflow-x-auto">
          <a href="#about" className="text-sm font-medium whitespace-nowrap hover:text-[#FFD100] transition-colors">
            About
          </a>
          ...
          <a
            href="#publications"
            className="text-sm font-medium whitespace-nowrap hover:text-[#FFD100] transition-colors"
          >
            Publications
          </a>
      ...
      <div className="max-w-5xl mx-auto p-6 md:p-8">
        {websiteSettings.sections.about && (
          <div id="about" className="mb-12 bg-white rounded-xl shadow-sm p-6 md:p-8">
            <h2 className="text-2xl font-bold text-black mb-4 border-b-2 border-[#FFD100] pb-2 inline-block">About Me</h2>
            <p className="text-gray-700 leading-relaxed">
              Innovative academic researcher with a passion for pushing the boundaries of knowledge. My research focuses
              on the intersection of computer science and practical applications.
            </p>
          </div>
        )}
