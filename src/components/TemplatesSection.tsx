      ...
      <div className='p-6'>
        ...
        <Link to='/templates'>
          <Button
            variant='outline'
            size='sm'
            className='text-academic-orange border-academic-orange hover:bg-orange-50'>
            Preview Template
          </Button>
        </Link>
      </div>
