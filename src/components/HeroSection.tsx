        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
          <div className='flex flex-col gap-6'>
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-academic-dark leading-tight'>
              ...
              <span className='text-academic-orange'>In One Place</span>
            </h1>
            <p className='text-lg text-gray-600 max-w-lg'>
              Transform your CV into a professional digital presence. Upload,
              edit, and showcase your academic achievements with ease.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 mt-2'>
              <Link to='/signup'>
                <Button className='bg-academic-orange hover:bg-academic-orange/90 text-white px-8 py-6 h-auto text-lg'>
                  Get Started
                </Button>
              </Link>
              <Link to='/templates'>
